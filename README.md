# nvim-treesitter-queries-vala

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-vala/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-vala/actions/workflows/validate.yml)

Neovim tree-sitter queries for **vala**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-vala",
...
- [ ] Changes are scoped to `vala` — do not include files for other languages
